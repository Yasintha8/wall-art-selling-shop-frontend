                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                        ...
                        <div className="relative">
                            <div className="lg:sticky lg:top-8">
                                {/* Mobile: Full width with margin, Desktop: Card style */}
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                <div className="flex items-start justify-between mb-4">
                                    <div className="flex-1">
                                        <h1 className="mt-8 sm:mt-0 text-4xl font-bold text-gray-900 leading-tight mb-2">
                                            {product.name}
                                            </h1>
                            ...
                            <div className="space-y-4">
                                <button
                                    ...
                                    className="w-full h-14 bg-primary text-white font-semibold rounded-xl shadow-lg hover:bg-primary/90 hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center space-x-2 cursor-pointer"
                                >
                                ...
                                <button
                                    ...
                                    className="w-full h-14 bg-gradient-to-r from-secondary to-secondary/90 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:from-secondary/90 hover:to-secondary transform hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center space-x-2 cursor-pointer"
                                >
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="grid grid-cols-2 gap-4 pt-6 border-t border-gray-200">
                                <div className="text-center p-4 bg-blue-50 rounded-lg">
                                    ...
                                    <p className="text-sm font-medium text-blue-900">Easy Returns</p>
            ...
            {status === "error" && (
                <div className="min-h-screen flex items-center justify-center">
                    <div className="text-center max-w-md mx-auto p-8">
                        ...
                        <p className="text-gray-600 mb-6">Sorry, we couldn't load this product. Please try again later.</p>
                        <button
