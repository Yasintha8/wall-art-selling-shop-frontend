                        ...
                        <div className="space-y-6 sm:space-y-8">
                            ...
                            <div className="space-y-3 sm:space-y-4">
                                <button
                                    ...
                                    className="w-full h-12 sm:h-14 bg-primary text-white text-sm sm:text-base font-semibold rounded-xl shadow-lg hover:bg-primary/90 hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center space-x-2"
                                >
